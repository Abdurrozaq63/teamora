        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-gray-500">
              <tr>
                <th className="py-2">Project</th> <th>Status</th> <th>Tasks</th>
                <th>Last Updated</th>
              </tr>
            </thead>
            <tbody className="text-gray-700 dark:text-gray-300">
              <tr className="border-t border-gray-200 dark:border-gray-800">
                <td className="py-2">Website Revamp</td> <td>Active</td>
                <td>32</td> <td>2 hours ago</td>
              </tr>
              <tr className="border-t border-gray-200 dark:border-gray-800">
                <td className="py-2">Mobile App</td> <td>In Progress</td>
                <td>54</td> <td>1 day ago</td>
              </tr>
              <tr className="border-t border-gray-200 dark:border-gray-800">
                <td className="py-2">API Development</td> <td>Completed</td>
                <td>42</td> <td>3 days ago</td>
              </tr>
            </tbody>
          </table>
        </div>
